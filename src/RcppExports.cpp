...
RcppExport SEXP _rDIAUtils_smallestDifferentStrings(SEXP cStringsSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_rDIAUtils_smallestDifferentStrings", (DL_FUNC) &_rDIAUtils_smallestDifferentStrings, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_rDIAUtils(DllInfo *dll) {
